...
/**
 * Ref: https://docs.wpilib.org/en/latest/docs/software/commandbased/convenience-features.html
 * Wrapper class to convert a normal method into a command, allows running of methods from the dashboard
