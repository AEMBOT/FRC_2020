...
public class MotionProfiling {
    ...
    /**
     * Create a new motion profiling object given the distance we want to move and the max acceleration to get there
    ...
    public MotionProfiling(double distance, double maxAcceleration, double desiredMaxSpeed){
        ...
        //While maxSpeed is still too big for the desired max speed recalculate the acceleration
