...
/**
 * Class created to house all the mappings for the robot All variables in this
 * class are static
 */
public class RobotMap {
    ...
    public static final int LeftMiddleMotor = 2;
    ...
    public static final int RightMiddleMotor = 5;
